...
if(isset($_GET['SubCategoryID'])){
    ...
    $Delete = "DELETE FROM sub_category WHERE SubCategoryID = $id" ; 
    $result1 = mysqli_query($conn , $Delete);


    if ($result1) {
        header("Location: subcategory.php?msg=L'utilisateur a éte suprimmer");
      } else {
  ...
  if (isset($_POST['submit'])) {
          ...
          $Nom = $_POST['SubCategoryName'];
        
  
          $sqlADD = "INSERT INTO `sub_category`(`SubCategoryName`) VALUES ('$Nom')";
          $ResultADD = mysqli_query($conn, $sqlADD);
  
          if ($ResultADD) {
              header("Location: subCategory.php?msg=Le Category a éte Ajouter avec succes");
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title bg-primary" >
				<div class="row">
					<div class="col-sm-6">
						<h2 id="SQLI">SQLI<b>i</b>-Sub Category</h2>
					</div>
					<div class="col-sm-6">
