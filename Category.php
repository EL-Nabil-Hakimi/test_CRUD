...
if(isset($_GET['categoryID'])){
    ...
    $sqltSUB = "SELECT * FROM sub_category WHERE categoryID =$id" ; 
    $rel = mysqli_query($conn , $sqltSUB);

    while($row = mysqli_fetch_assoc($rel)){
      $Delete = "DELETE FROM sub_category WHERE categoryID = $id " ; 
    ...
    if ($result1) {
        header("Location: category.php?msg=L'utilisateur a éte suprimmer");
      } else {
  ...
  if (isset($_POST['submit'])) {
          ...
          $sqlADD = "INSERT INTO `category`(`CategoryName`) VALUES ('$Nom')";
          $ResultADD = mysqli_query($conn, $sqlADD);
  
          if ($ResultADD) {
              header("Location: Category.php?msg=Le Category a éte Ajouter avec succes");
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title bg-primary" >
				<div class="row">
					<div class="col-sm-6">
						<h2 id="SQLI">SQLI<b>i</b>-Category</h2>
					</div>
					<div class="col-sm-6">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="UpdateCategory.php?CategoryID=<?php echo $row['categoryID'] ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="Category.php?categoryID=<?php echo $row['categoryID'] ?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
