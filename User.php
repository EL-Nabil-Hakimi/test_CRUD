...
if(isset($_GET['iduser'])){
    ...
    if ($result1) {
        header("Location: user.php?msg=L'utilisateur a éte suprimmer");
      } else {
  ...
  if (isset($_POST['submit'])) {
      try {
          ...
          $sqlADD = "INSERT INTO `user`(`Nom`, `Prenom`, `Email`) VALUES ('$Nom','$Prenom','$Email')";
          $ResultADD = mysqli_query($conn, $sqlADD);
  
          if ($ResultADD) {
              header("Location: user.php?msg=L'utilisateur a éte Modifier avec succes");
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title bg-primary" >
				<div class="row">
					<div class="col-sm-6">
						<h2 id="SQLI">SQLI<b>i</b>-Utilisateur</h2>
					</div>
					<div class="col-sm-6">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="UpdateUser.php?userID=<?php echo $row['Userid'] ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="User.php?iduser=<?php echo $row['Userid'] ?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
