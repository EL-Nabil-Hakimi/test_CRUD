...
if (isset($_POST['Edit'])) {
    ...
    $sqlEDIT = "UPDATE `category` SET `CategoryName`='$Nom' WHERE CategoryID = $id";
    $ResultEDIT = mysqli_query($conn, $sqlEDIT);

    if ($ResultEDIT) {
        header("Location: Category.php?msg=L'utilisateur a été modifié avec succès");
    } else {
	...
	<div class="modal-dialog">
		...
		<form method="post" >
				<div class="modal-header">						
					<h4 class="modal-title">La Modification Du Category</h4>
				</div>
				<div class="modal-body">					
					<div class="form-group">
						<label>Nom</label>
						<input type="text" name="Nom" class="form-control" value = "<?php echo $row['CategoryName'] ?>" required>
					</div>
				
					
				<div class="modal-footer">
				    <a href = "Category.php"><input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel"></a>
